...
async def save_thumb_nail(client,message):
 ...
 if message.reply_to_message is not None:
  ...
  downloaded_file_name=await client.download_media(message=message.reply_to_message,file_name=download_location)
  ...
  await ismgs.edit("Custom video / file thumbnail saved. "+"This image will be used in the upload, till /clearthumbnail.")
 else:
